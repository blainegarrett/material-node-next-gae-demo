  ...
  <div>
    ...
    <footer className="footer">
      <div className="footer-inner">
        <p>Demo is a port of the <a href="https://github.com/blainegarrett/material-node-next-gae-demo">node-material-next-gae</a> demo project and <a href="https://github.com/mui-org/material-ui/tree/v1-beta/examples/nextjs" target="_new">Material-UI Next.js example</a>.</p>
